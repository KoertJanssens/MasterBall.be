var style = '<style>html, body{width: 100%;height: 100%;margin: 0px;padding: 0px;position: relative;} .centered-block {max-height: 50%;margin-right: auto;text-align: center;} .g-recaptcha div{margin-right: auto; text-align: center;} .img-responsive{max-width: 90%;height: 100%;} #timer,#status{text-align: center;padding-bottom: 4px;} #messages{margin-right: auto;width: 180px;font-size: 14px;padding: 4px;border: 1px solid grey;border-radius: 4px;background: ghostwhite;font-family: sans-serif;} .label{width: 140px;text-align: right;padding-right: 2px;display: inline-block;}</style>';
